...
from EPF_Import_Functions import EPF_import_bestiary, EPF_import_item
...
async def import_data(file: str, ledger, async_session):
    ...
    ledger = await tally_results(await EPF_import_item(file, async_session), ledger, "EPF_Items")
    return ledger
